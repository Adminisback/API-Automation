...
public class Demo1ExcellData {
	...
	public static List<String> getData(String testCaseName, String requiredSheetName) throws IOException {
		...
		//It accepts FileInpute Strame argument
				...
				for(int i = 0; i<numberOfSheets; i++) {
					if(xsswb.getSheetName(i).equalsIgnoreCase(requiredSheetName)) {
